...
void ui_init(void)
{
    ...
    ui_ScreenTemperature_screen_init();
...
void ui_destroy(void)
{
    ...
    ui_ScreenPrintStatus_screen_destroy();
    ui_ScreenJog_screen_destroy();
    ui_ScreenTMC_screen_destroy();
    ui_ScreenFilament_screen_destroy();
    ui_ScreenFiles_screen_destroy();
    ui_ScreenSettings_screen_destroy();
    ui_ScreenAbout_screen_destroy();
    ui_ScreenTemperature_screen_destroy();
}
